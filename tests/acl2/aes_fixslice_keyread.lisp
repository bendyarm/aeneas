...
(defthm core-windows-explicit
  (implies (wok rk key 80 10)
           (and (equal (rd8 rk 80) (result-ok->val (aes-fixslice-encrypt-bitslice (kk-iter key 10) (kk-iter key 10)))) (equal (rd8 rk 72) (result-ok->val (aes-fixslice-encrypt-bitslice (kk-iter key 9) (kk-iter key 9)))) (equal (rd8 rk 64) (result-ok->val (aes-fixslice-encrypt-bitslice (kk-iter key 8) (kk-iter key 8)))) (equal (rd8 rk 56) (result-ok->val (aes-fixslice-encrypt-bitslice (kk-iter key 7) (kk-iter key 7)))) (equal (rd8 rk 48) (result-ok->val (aes-fixslice-encrypt-bitslice (kk-iter key 6) (kk-iter key 6)))) (equal (rd8 rk 40) (result-ok->val (aes-fixslice-encrypt-bitslice (kk-iter key 5) (kk-iter key 5)))) (equal (rd8 rk 32) (result-ok->val (aes-fixslice-encrypt-bitslice (kk-iter key 4) (kk-iter key 4)))) (equal (rd8 rk 24) (result-ok->val (aes-fixslice-encrypt-bitslice (kk-iter key 3) (kk-iter key 3)))) (equal (rd8 rk 16) (result-ok->val (aes-fixslice-encrypt-bitslice (kk-iter key 2) (kk-iter key 2)))) (equal (rd8 rk 8) (result-ok->val (aes-fixslice-encrypt-bitslice (kk-iter key 1) (kk-iter key 1)))) (equal (rd8 rk 0) (result-ok->val (aes-fixslice-encrypt-bitslice (kk-iter key 0) (kk-iter key 0))))))
  :hints (("Goal" :do-not-induct t
